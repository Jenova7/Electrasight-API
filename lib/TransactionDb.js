...
var bitcore = require('Electracore'),
...
var encodedData = require('soop').load('Electracore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('Electracore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('Electracore/lib/Address', {
